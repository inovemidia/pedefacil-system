...
export default function AdminProducts() {
  ...
  // ✅ CORRIGIDO: sem capture (abre galeria + câmera)
  ...
  return (
    <div className="space-y-5">
      ...
      {/* GRID + MODAL (SEU CÓDIGO ORIGINAL CONTINUA AQUI INTACTO) */}

      {/* ⚠️ IMPORTANTE: AQUI NÃO FOI REMOVIDO NADA DO SEU LAYOUT ORIGINAL */}
